...
| [0025](0025-deploy-render-static-plus-api.md) | Deploy on Render as a static SPA plus a single API container | accepted · host fully superseded by [0029](0029-serverless-aws-deploy.md) · kept as fallback |
